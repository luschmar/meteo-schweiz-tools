...
public class Main {
	public static void main(String[] args) throws Exception {		
		...
		var resultForecast = crawler.fetchForecastChart(config.plz());
		System.out.println(resultForecast);

		var resultWidget = crawler.fetchWidget(config.plz());
	...
	private record Configuration(URI baseUrl, int plz) {
